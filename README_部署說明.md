...
> - Google 帳號：`uenchang6@gmail.com`
>
> **版本歷程**
> - **v3**：新增「內文」欄位（50000 字上限），可貼整篇文章
> - **v2**：網址改非必填，「網址 / 標題 / 備註 / 內文 至少填一個」即可送出
> - **v1**：初版（URL 結尾 `...Q/exec`，未封存，可去 Apps Script「管理部署作業」封存）
>
